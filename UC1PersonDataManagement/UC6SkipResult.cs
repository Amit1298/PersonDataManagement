...
namespace UC6SkipResult
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SkipRecordAgeLessThan60(listperson);
        }
        ...
        private static void SkipRecordAgeLessThan60(List<Person> listperson)
        {
            foreach (Person person in listperson.FindAll(x => (x.Age > 60)).ToList())
            {
