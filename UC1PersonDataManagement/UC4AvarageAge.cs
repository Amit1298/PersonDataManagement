...
namespace UC4AvarageAge
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            RetrevingAvarageAge(listperson);
        }
        ...
        private static void RetrevingAvarageAge(List<Person> listperson)
        {
            double AvgAge = listperson.Average(x => x.Age);
